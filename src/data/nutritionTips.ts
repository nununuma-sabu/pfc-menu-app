...
export const nutritionTips: NutritionTipData[] = [
    ...
    // 炭水化物
    {
        title: "炭水化物",
        category: "三大栄養素",
        content: "体を動かすメインのエネルギー源です。不足すると筋肉が分解されて代謝が落ちる原因になるため、極端に減らさず適量を摂ることが大切です。"
    },
    // 脂質
    {
        title: "脂質",
        category: "三大栄養素",
        content: "細胞やホルモンの材料となり、腹持ちを良くする役割もあります。カロリーは高いですが、良質なものを適量摂ることで健康的なダイエットをサポートします。"
    },
    // ビタミン群（調子を整える・代謝サポート）
    {
        title: "ビタミンA",
